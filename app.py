...
<div class="logic">
  ...
  <div class="logic-step">
    ...
    <div class="logic-card">
      <b>종합 진단</b><span class="tag">Summ 2.0</span><br>
      단일 원인 특정은 어려움 → <b>방문 행동 구조</b> 관점 문제. 코호트로 보면 25년 고빈도의 <b>38%가 중·저빈도로 이탈</b>,
      25년 중빈도의 <b>49%가 저빈도화</b> = 기존 충성 VIP의 저빈도화.
      → 추가 원인 탐색 전, <b>확인된 약화 구간에 CRM 파일럿 선행</b>.
    </div>
  </div>
  <div class="logic-step final">
    <div class="logic-num">✓</div>
    <div class="logic-card ok">
      <b>관점 전환 & 방향</b><span class="tag">Summ 3.0</span><br>
      AS-IS <i>"무엇을 만들어야 DAU가 개선되나"</i> → TO-BE <b>"재방문 계기를 적시·적합하게 전달하고 있나"</b>.
      CRM 4축 점검(접점량은 충분: 앱푸시 1일 6회·문자 2회) 결과 두 축으로 수렴:<br>
      ① <b>행동 기반 트리거</b> — 현재 발송이 <b>최소 D-1(하루 전) 데이터</b> 기반 → 조회·장바구니·위시 등 <b>행동 발생 직후 대응 불가</b>
      → 행동 발생 시점 기반 CRM으로.<br>
      ② <b>채널 접점·도달력</b> — 앱푸시 수신 가능 상태 = 재방문 접점 → <b>도달력 점검·확대</b> (앞의 도달 진단이 이 축).
    </div>
  </div>
</div>
""", unsafe_allow_html=True)
